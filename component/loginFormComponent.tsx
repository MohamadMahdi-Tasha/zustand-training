...
export default function LoginFormComponent():ReactNode {
    ...
    return (
        <form 
            ...
            action="#" 
            className="lg:p-[20px] p-[10px] lg:gap-[20px] gap-[15px] flex flex-col lg:rounded-[20px] rounded-[10px] lg:w-[50%] w-full bg-blue shadow-xl border-4 transition data-[valid='true']:border-green-600 data-[valid='false']:border-red-600"
        >
